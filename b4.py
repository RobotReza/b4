...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update ROBOT Tool')
	print (S + '[' + P + '☞3' + S + ']' + S + ' ROBOT_REZA')
...
def mb():
	...
	if bm =='':
	    ...
	    psb('WellCome To ROBOT tool')
	    psb('Congratulations ROBOT Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ ROBOT✓')
	    psb('🔓Password ☆ Reza✓')
